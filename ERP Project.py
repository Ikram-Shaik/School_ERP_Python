...
def Status_Hover_Leave(e):
    Status_Bar.config(text='Coded By: Shaik Mohammed Ikram                ')
    
def Status_Hover1(e):
    Status_Bar1.config(text='')
    
def Status_Hover_Leave1(e):
    Status_Bar1.config(text='Coded By: Shaik Mohammed Ikram                ')
    
def Status_Hover2(e):
    Status_Bar2.config(text='')
    
def Status_Hover_Leave2(e):
    Status_Bar2.config(text='Coded By: Shaik Mohammed Ikram                ')
    
def Status_Hover3(e):
    Status_Bar3.config(text='')
    
def Status_Hover_Leave3(e):
    Status_Bar3.config(text='Coded By: Shaik Mohammed Ikram                ')
    
def Status_Hover4(e):
    Status_Bar4.config(text='')
    
def Status_Hover_Leave4(e):
    Status_Bar4.config(text='Coded By: Shaik Mohammed Ikram                ')
    
def Status_Hover5(e):
    Status_Bar5.config(text='')
    
def Status_Hover_Leave5(e):
    Status_Bar5.config(text='Coded By: Shaik Mohammed Ikram                ')
    
def Status_Hover6(e):
    Status_Bar6.config(text='')
    
def Status_Hover_Leave6(e):
    Status_Bar6.config(text='Coded By: Shaik Mohammed Ikram                ')
    
def Status_Hover7(e):
    Status_Bar7.config(text='')
    
def Status_Hover_Leave7(e):
    Status_Bar7.config(text='Coded By: Shaik Mohammed Ikram                ')
...
def Status_Hover_Leave8(e):
    Status_Bar8.config(text='Coded By: Shaik Mohammed Ikram                ')
...
def Tree_Screen():
    ...
    resized=my_pic.resize((1000,600),Image.Resampling.LANCZOS)
    ...
    resized = image.resize((120, 150), Image.Resampling.LANCZOS)
    ...
    mycon=pym.connect(host='localhost',user='root',passwd='Ikram**123',database='school')
    cur=mycon.cursor()
    ...
    resized3=my_pic3.resize((140,80),Image.Resampling.LANCZOS)
    ...
    global Status_Bar8
    Status_Bar8 = tk.Label(tree, text='Coded By: Shaik Mohammed Ikram            ', font=('bold'), bd=1,
...
def Admin_Delete_Details(Adno):
    ...
    for stu in data:
        if stu[0]==Adno:
            ...
            global resized10
            resized10 = my_pic10.resize((140, 60), Image.Resampling.LANCZOS)
            global new_pic10
...
def Delete_Record_Screen():
    ...
    global Status_Bar7
    Status_Bar7=tk.Label(dele,text='Coded By: Shaik Mohammed Ikram            ',font=('bold'),bd=1,relief='sunken',anchor='e')
...
def Add_Record_Sceen():
    ...
    resized4 = my_pic4.resize((220, 75), Image.Resampling.LANCZOS)
    ...
    resized3=my_pic3.resize((175,75),Image.Resampling.LANCZOS)
    new_pic3=ImageTk.PhotoImage(resized3)
    ...
    global Status_Bar6
    Status_Bar6=tk.Label(rec,text='Coded By: Shaik Mohammed Ikram            ',font=('bold'),bd=1,relief='sunken',anchor='e')
...
def Admin_Update_Details(Adno):
    ...
    for stu in data:
        if stu[0]==Adno:
            ...
            global resized
            resized = my_pic.resize((175, 75), Image.Resampling.LANCZOS)
            global new_pic
            new_pic = ImageTk.PhotoImage(resized)
...
def Admin_Update_Screen():
    ...
    global Status_Bar5
    Status_Bar5=tk.Label(run,text='Coded By: Shaik Mohammed Ikram            ',font=('bold'),bd=1,relief='sunken',anchor='e')
...
def Admin_Check_Screen():
    ...
    resized = image.resize((150, 170), Image.Resampling.LANCZOS)
    image = ImageTk.PhotoImage(resized)
    ...
    resized3=my_pic3.resize((240,100),Image.Resampling.LANCZOS)
    new_pic3=ImageTk.PhotoImage(resized3)
    ...
    global Status_Bar4
    Status_Bar4=tk.Label(top3,text='Coded By: Shaik Mohammed Ikram            ',font=('bold'),bd=1,relief='sunken',anchor='e')
...
def Student_Screen():
    ...
    resized1 = image1.resize((155, 160), Image.Resampling.LANCZOS)
    ...
    global Status_Bar3
    Status_Bar3=tk.Label(top2,text='Coded By: Shaik Mohammed Ikram            ',font=('bold'),bd=1,relief='sunken',anchor='e')
...
def Login_Screen():
    ...
    resized2=my_pic2.resize((1000,600),Image.Resampling.LANCZOS)
    ...
    resized = image.resize((120, 120), Image.Resampling.LANCZOS)
    image = ImageTk.PhotoImage(resized)
    ...
    resized8=my_pic8.resize((220,75),Image.Resampling.LANCZOS)
    ...
    resized9=my_pic9.resize((220,75),Image.Resampling.LANCZOS)
    ...
    global Status_Bar2
    Status_Bar2=tk.Label(top1,text='Coded By: Shaik Mohammed Ikram            ',font=('bold'),bd=1,relief='sunken',anchor='e')
...
def Create_Account_Screen():
    ...
    resized = image1.resize((120, 120), Image.Resampling.LANCZOS)
    ...
    resized3=my_pic3.resize((220,75),Image.Resampling.LANCZOS)
    new_pic3=ImageTk.PhotoImage(resized3)
    ...
    global Status_Bar1
    Status_Bar1=tk.Label(top,text='Coded By: Shaik Mohammed Ikram            ',font=('bold'),bd=1,relief='sunken',anchor='e')
...
def Developers_Screen():
    ...
    Heading = tk.Label(dev, text='GVK CHINMAYA VIDYALAYA', bg='black', fg='red',font=("Helvetica", "35", "bold italic"))
    Heading.place(x=250, y=15)
    
    Heading=tk.Label(dev,text='Developer',bg='black',fg='white',font=("Helvetica","30","bold italic"))
    Heading.place(x=425,y=90)
    
    my_pic=Image.open('Ikram.jpg')
    resized=my_pic.resize((300 ,300),Image.Resampling.LANCZOS)
    new_pic=ImageTk.PhotoImage(resized)
    
    
    Ikram_pic=tk.Label(dev,image=new_pic,bd=4)
    Ikram_pic.place(x=80,y=150)
    
    Name=tk.Label(dev,text='Name :',bg='black',fg='white',font=("Helvetica","25","bold"))
    
    Class=tk.Label(dev,text='Class :',bg='black',fg='white',font=("Helvetica","25","bold"))

    Address=tk.Label(dev,text='City :',bg='black',fg='white',font=("Helvetica","25","bold"))

    Gmail=tk.Label(dev,text='Mail :',bg='black',fg='white',font=("Helvetica","25","bold"))

    Github=tk.Label(dev,text='Github :',bg='black',fg='white',font=("Helvetica","25","bold"))
    
    Ikram_Label=tk.Label(dev,text='Mohammed Ikram',bg='black',fg='white',font=("Albertus Extra Bold","28","bold"))
    
    Class_Label=tk.Label(dev,text='12',bg='black',fg='white',font=("Albertus Extra Bold","28","bold"))

    Address_Label=tk.Label(dev,text='Nellore, Andhra Pradesh',bg='black',fg='white',font=("Albertus Extra Bold","23","bold"))

    Gmail_Label=tk.Label(dev,text='ikramshaik.cse.ai@gmail.com',bg='black',fg='white',font=("Albertus Extra Bold","23","bold"))

    Github_Label=tk.Label(dev,text='github.com/Ikram-Shaik',bg='black',fg='white',font=("Albertus Extra Bold","23","bold"))
    
    Name.place(x=420,y=160)
    Ikram_Label.place(x=550,y=160)
    Class.place(x=420,y=220)
    Class_Label.place(x=550,y=220)
    Address.place(x=420,y=280)
    Address_Label.place(x=520,y=280)
    Gmail.place(x=420,y=350)
    Gmail_Label.place(x=520,y=350)
    Github.place(x=420,y=410)
    Github_Label.place(x=560,y=410)
    
    
    my_pic3=Image.open('Home.jpg')
  
    resized3=my_pic3.resize((200,90),Image.Resampling.LANCZOS)
    new_pic3=ImageTk.PhotoImage(resized3)
...
def Home_Screen():
    ...
    resized1=my_pic1.resize((400 ,75),Image.Resampling.LANCZOS)
    ...
    resized5=my_pic5.resize((400,75),Image.Resampling.LANCZOS)
    ...
    resized6=my_pic6.resize((200,125),Image.Resampling.LANCZOS)
    ...
    global Status_Bar
    Status_Bar=tk.Label(root,text='Coded By: Shaik Mohammed Ikram            ',font=('bold'),bd=1,relief='sunken',anchor='e')
    ...
    resized10=my_pic10.resize((200,100),Image.Resampling.LANCZOS)
    new_pic10=ImageTk.PhotoImage(resized10)
